...
///////////////////////////////////////////////////////
// default img and loading captions
...
//     if (contentItem) {
//       contentItem.classList.add('liked');
//       setTimeout(() => contentItem.classList.remove('liked'), 1200); // 1.2s red animation
//     }
...
//                     className="content-image"
//                     onClick={() => setShowImageModal(content._id)}
//                     onError={(e) => console.log('Image load error:', e.target.src, e)} // Debug image load issues
//                   />
//                 )}
//                 <div className="content-footer">
//                   <span>{new Date(content.createdAt).toLocaleString()}</span>
...
//         console.log('Fetched user data:', response.data.user);
//         setUser(response.data.user);
//         setNewName(response.data.user.name); // Initialize newName with current name
//       } catch (err) {
//         console.error('Fetch user error:', err);
//         navigate('/login');
//       } finally {
